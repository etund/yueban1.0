 ...
 */
+ (instancetype)tabBarControllerWithTitleArray:(NSArray *)titles
                               andNormalImages:(NSArray *)nomalImages
                             andSelectedImages:(NSArray *)selectedImages
                                  andClassName:(NSArray *)classNames;
...
+ (instancetype)tabBarControllerWithTitleArray:(NSArray *)titles
                             ...
                             andSelectedImages:(NSArray *)selectedImages
                                  andClassName:(NSArray *)classNames
                                withNavigation:(Class)navigationClass;
...
+ (instancetype)tabBarControllerWithTitleArray:(NSArray *)titles
                             ...
                             andSelectedImages:(NSArray *)selectedImages
                                  andClassName:(NSArray *)classNames
                                withNavigation:(Class)navigationClass
                            andSelfTabBarClass:(Class)tabBarClass;
